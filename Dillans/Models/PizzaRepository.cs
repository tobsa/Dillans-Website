            ...
            return new List<PizzaGroup>()
            {
                ...
                new PizzaGroup()
                {
                    ...
                    Pizzas = new List<Pizza>()
                    {
                        ...
                        new Pizza(58, "Ravelli", new List<Ingredient>() { Ingredient.Kebabkött, Ingredient.Tacosås, Ingredient.Jalapeno, Ingredient.Lök, Ingredient.Vitlök, Ingredient.Kebabsås}),
                        new Pizza(59, "Malta", new List<Ingredient>() { Ingredient.Ost, Ingredient.Kebabkött, Ingredient.Lök, Ingredient.Isbergssallad, Ingredient.Tomat, Ingredient.Gurka, Ingredient.Feferoni, Ingredient.Kebabsås}, new List<Type>() { Type.Inbakad }),
                        new Pizza(60, "Alpina", new List<Ingredient>() { Ingredient.Fläskfile, Ingredient.Lök, Ingredient.Vitlök, Ingredient.Tacosås, Ingredient.Kebabsås }),
                        new Pizza(61, "Herkules", new List<Ingredient>() { Ingredient.Fläskfile, Ingredient.Champinjoner, Ingredient.Lök, Ingredient.Bearnaisesås }),
                        new Pizza(62, "Rimini", new List<Ingredient>() { Ingredient.Fläskfile, Ingredient.Lök, Ingredient.Skinka, Ingredient.Bearnaisesås }),
                        new Pizza(63, "Petto", new List<Ingredient>() { Ingredient.Kyckling, Ingredient.Kräftstjärtar, Ingredient.Ananas, Ingredient.Banan, Ingredient.Curry, Ingredient.Jordnötter, Ingredient.Kebabsås }),
